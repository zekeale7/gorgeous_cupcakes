<?php
	...
	{ 
		...
		header("location:../view/product_add_form.php");
		exit();
	}
	...
	if(!empty($_FILES['productPhoto']['name']))
	{
		...
		//call the add_product_with_photo() function
		$result = add_product_with_photo($productName, $productDescription, $productPrice, $newPhotoName, $categoryID);
	...
	else
	{
		...
		$result = add_product($productName, $productDescription, $productPrice, $categoryID);
